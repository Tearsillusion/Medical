$(document).ready(
    ...
    function(){
        ...
        var json0 = { "width":102, "height":102, "top":30, "left":-70};

        var json1 = { "width":124, "height":124, "top":30, "left":-83}

        var json2 = { "width":148, "height":148, "top":20, "left":58}

        var json3 = { "width":179, "height":179, "top":5, "left":220 }

        var json4 = { "width":148, "height":148, "top":20, "left":415 }

        var json5 = { "width":124, "height":124, "top":30, "left":575}

        var json6 = { "width":102, "height":102, "top":30, "left":693 }

// 定时轮播
 clearInterval(setTime);
var setTime=setInterval(function time(){
...
// 触碰停止轮播代码
$('.youanniu').bind('mouseover mouseout', function(event) {
  if (event.type == 'mouseover') {
     clearInterval(setTime);
  } else {
    clearInterval(setTime);
     setTime=setInterval(function time(){
...
// 左箭头
$('.zuoanniu').bind('mouseover mouseout', function(event) {
  if (event.type == 'mouseover') {
     clearInterval(setTime);
  } else {
    clearInterval(setTime);
...
//导航触摸停止
$('#yixing').bind('mouseover mouseout', function(event) {
  if (event.type == 'mouseover') {
     clearInterval(setTime);
  } else {
    clearInterval(setTime);
